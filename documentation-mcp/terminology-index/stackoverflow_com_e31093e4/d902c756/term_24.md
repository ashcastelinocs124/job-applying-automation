...
## Context
n instead of the generic `Exception` (and the result will be that you still derive from `Exception` as the docs recommend). Also, you can at least provide a docstring (and not be forced to use the `pass
